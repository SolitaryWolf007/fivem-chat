// Configuração
//console.log('Starting chat app initialization...');
...
Vue.component('message', {
  ...
  computed: {
    textEscaped() {
      ...
      // Hack para preservar compatibilidade
      if (!this.template && this.templateId == CONFIG.defaultTemplateId && this.args.length == 1) {
